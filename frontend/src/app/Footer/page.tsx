...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-500 to-blue-500 text-white py-8 mt-10">
      <div className="container mx-auto text-center">
        <p className="mb-4 text-2xl flex justify-center items-center">
        ...
        <p className="mt-4 text-xl">
          ...
          <a
            ...
            className="text-blue-300 underline flex justify-center items-center"
          >
